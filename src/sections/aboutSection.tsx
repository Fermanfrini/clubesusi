    ...
    >
      ...
      >
        <div className="flex w-full min-w-[50%] flex-col items-center justify-center gap-6 p-5">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold xl:text-4xl">
              Descubra o que torna o Clube Susi tão incrível!
            </h2>
          </div>
          <p className="text-center text-sm font-light md:text-base xl:text-lg">
            Bem-vindo ao Clube Susi, onde paixão pelos animais se une à excelência
            ...
            fazem parte da sua família. Entendemos que cada
        ...
        <Image
          ref={refQuote}
          src={AboutMosaic}
          alt="Mosaico de imagens da Susi"
          sizes="100vw"
          width={0}
          height={0}
